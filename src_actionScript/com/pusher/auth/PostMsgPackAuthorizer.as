package com.pusher.auth{
	 ...
	 */
	public class PostMsgPackAuthorizer implements IAuthorizer{
		 ...
		 */		
		public function PostMsgPackAuthorizer(endPoint:String){
		...
		public function authorize(pusher:Pusher, channel:Channel, callback:Function):void{
			...
			request.data = Utils.getMessagePack(postVars);
